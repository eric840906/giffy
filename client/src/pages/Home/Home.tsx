    ...
    <div className="flex flex-col items-center gap-8">
      ...
      <div className="grid w-full grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {TOOLS.map((tool) => (
          ...
          >
            <div className="mb-3">
              <tool.icon size={32} weight="duotone" className="text-mint-500 dark:text-mint-400" />
            </div>
            <h2 className="text-lg font-semibold text-gray-800 group-hover:text-mint-600 dark:text-gray-100 dark:group-hover:text-mint-400">
